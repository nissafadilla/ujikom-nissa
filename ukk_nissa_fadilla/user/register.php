...
<body class="bg-white font-[Poppins] min-h-[100vh] pt-[2rem] relative">
    ...
    <div class="bg-white flex justify-center items-center h-screen">
        <div class="bg-[#CD6262] w-96 p-6 shadow-lg rounded-md flex flex-col space-y-5">
            ...
            <form class="gap-4" action="../service/register_service.php" method="post">
                <div class="flex flex-col space-y-5">
                    ...
                    <div>
                        ...
                        <input class="border border-black rounded-lg w-full px-3" name="email" id="email" type="text" required/>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input class="border border-black rounded-lg w-full px-3" name="fullName" id="fullName" type="text" required/>
                    </div>
                    <div>
                        <label class="text-white" for="address">Address :</label>
                        <input class="border border-black rounded-lg w-full px-3" name="address" id="address" type="text" required/>
                    </div>
                </div>
                <div class="mt-3">
                    <button class="bg-[#E9C874] px-[1rem] py-[0.2rem] rounded-lg" type="submit" name="submit">Register</button>
                </div>
            </form>
