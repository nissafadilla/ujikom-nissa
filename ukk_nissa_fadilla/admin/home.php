...
<body class="bg-white font-[Poppins] min-h-[100vh] pt-[8rem] relative">
    ...
    <div class="bg-white min-h-[50vh] p-9">
        <div class="bg-slate-100 rounded-lg relative p-10">
            <div class="p-5">
                <p class="text-2xl font-bold">My Image</p>
            </div>
            <div class="relative min-h-[40vh] flex flex-wrap justify-center mdCustom01:justify-between gap-[4rem]">
                <?php
